...
class DrawScoreAction(OutputAction):
    ...
    def execute(self, actors, actions, clock, callback):
        ...
        if (self._score_1 == None):
            ...
            #         break
        if self._score_1 != None:
            self._screen_service.draw_text("Score: " + str(self._score_1.get_score()), font_size=48, color=colors.WHITE, position= (20,20))
        ...
        if (self._score_2 == None):
            ...
            #         break
        if self._score_2 != None:
            self._screen_service.draw_text("Score: " + str(self._score_2.get_score()), font_size=48, color=colors.WHITE, position= (700,900))